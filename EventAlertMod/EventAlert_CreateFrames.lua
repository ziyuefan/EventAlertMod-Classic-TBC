...
function CreateFrames_CreateSpellListCfgBtn(SpellID, FrameNamePrefix, ParentFrameObj, LocOffsetX, LocOffsetY, FrameIndex)
	...
	SpellCfgBtn:SetNormalTexture(EventAlert_Image_Path.."UI-Panel-CfgButton-Down")
	SpellCfgBtn:SetHighlightTexture(EventAlert_Image_Path.."UI-Panel-CfgButton-Highlight", "BLEND")
...
function CreateFrames_CreateMinimapOptionFrame()
	...
	eaf:SetScript("OnEnter", function()	
								...
								t = t.."\124r"
								t = t.." - ON/OFF When CD ok, then remove the frame\n"
								
								t = t.."\124cff00FF00"
								t = t.."/eam SCDNocombatStillKeep"
								t = t.."\124r"
								t = t.." - ON/OFF When escape combat, CD frame still keep\n"
								
								t = t.."\124cff00FF00"
								t = t.."/eam SCDGlowWhenUsable"
								t = t.."\124r"
								t = t.." - ON/OFF When the spell's cd ok and can use, OVERGROW the spell\n"
								
								t = t.."\124cff00FF00"
								t = t.."/eam ShowEAconfig"
								t = t.."\124r"
								t = t.." - Same as /dump EA_Config \n"
								...
								t = t.."\124r"
								t = t.." - All Frame update interval, if PC's too bad, can bigger the sec\n"
